<%@ Page Language="C#" AutoEventWireup="true" CodeFile="truck-tracking.aspx.cs" Inherits="truck_tracking" %>
...
<head runat="server">
	...
	<title>Truck Booking Status | Maa Ambay Transport</title>
		...
		<div class="tracking">
			...
			<form id = "track_CourierBooking"  class="mb-3" runat="server" >
                ...
                <asp:Button ID="btn_track" runat="server" CssClass="btn btn-dark" Text="Track" OnClick="btn_track_Click" />&nbsp;&nbsp;&nbsp;
                  <asp:Button ID="btn_clear" runat="server" CssClass="btn btn-dark" Text="Clear" OnClick="btn_clear_Click" /><br/>
                <asp:Label ID="lbl_error" runat="server" Text=""></asp:Label><br/><br/><br/>
           </form>
	
      <div class="tracking-results">
			    <h3>Tracking Result : </h3><br/>
                <asp:Label ID="lbl_TruckTrackingID" runat="server" Text=""></asp:Label> &nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Origin" runat="server" Text=""></asp:Label>&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Destination" runat="server" Text=""></asp:Label>&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Distance" runat="server" Text=""></asp:Label>&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_NoOfDays" runat="server" Text=""></asp:Label>&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_TruckType" runat="server" Text=""></asp:Label>&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_DeliveryDate" runat="server" Text=""></asp:Label>&nbsp;&nbsp;&nbsp;
