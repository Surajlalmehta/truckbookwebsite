...
public partial class admin_login : System.Web.UI.Page
{
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        ...
        myCMD = new SqlCommand("SELECT * FROM users WHERE Email = @Email AND MyPassword = @Password AND UserRole = 'Admin'", conn);
        ...
        try
        {
            ...
            if (rowCount > 0)
            {
                Session["role"] = myDS.Tables["user"].Rows[i]["UserRole"].ToString();
